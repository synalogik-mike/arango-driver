...
1. [ Prerequisite. ](#prerequisite)
    ...
    a. [ Setup with installer. ](#installer)
1. [ ArangoDB basic concepts. ](#arangoconcepts)
1. [ Install the package. ](#installation)
1. [ Usage examples. ](#usage)
    a. [ Connection to ArangoDB server. ](#connectarango)
    a. [ Create or connect to a database. ](#connectdatabase)
    a. [ Create or load a collection. ](#createcollection)
    a. [ Insertion of documents into a collection. ](#insertcollection)
    a. [ Working with documents. ](#workingdocuments)
    a. [ Custom AQL queries. ](#aqlcustom)
    a. [ Working with graphs. ](#workinggrapphs)
